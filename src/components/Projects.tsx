...
const projects = [
  {
    ...
    description: 'A comprehensive web application for managing cricket club operations including player registration, match scheduling, and team management.',
    longDescription: 'Built a full-featured cricket club management system that handles player profiles, match scheduling, score tracking, and team analytics. The system includes admin dashboards, real-time updates, and comprehensive reporting features.',
